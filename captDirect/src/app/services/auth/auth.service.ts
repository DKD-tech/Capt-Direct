...
export class AuthService {
  private apiUrl = 'http://192.168.118.212:3000/api/auth'; // URL de l'API backend
  private apiUrlL = 'http://192.168.118.212:3000/api/user';
  private apiUrlSession = 'http://192.168.118.212:3000/api/session';
