...
export class AuthService {
  private apiUrl = 'http://172.20.10.2:3000/api/auth'; // URL de l'API backend
  private apiUrlL = 'http://172.20.10.2:3000/api/user';
  private apiUrlSession = 'http://172.20.10.2:3000/api/session';
